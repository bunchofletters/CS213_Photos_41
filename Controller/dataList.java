...
/**
 * This class serves as a data holder for the photo program. 
...
// -------------------------------------------------------------------------------------
    ...
    /**
     * @return HashMap mapping a String to a photoAlbumList
     */
...
// -------------------------------------------------------------------------------------
    ...
    /**
     * @return HashMap mapping a photoAlbumList to a listOfPhotos
     */
...
// -------------------------------------------------------------------------------------
    ...
    /**
     * HashMap of photo albums associated with each user.
     * @return HashMap mapping a String (user) to a photoAlbumList
     */
...
// -------------------------------------------------------------------------------------
     ...
     /**
     * HashMap containing lists of photos associated with each photo album.
     * @param dataToCopy The HashMap of photo albums to copy data from
     * @return HashMap mapping a photoAlbumList to a listOfPhotos
     */
...
// -------------------------------------------------------------------------------------
     ...
     * @param data The ObservableList of users to add
     */
...
// -------------------------------------------------------------------------------------
    ...
    /**
     * sets the photo album associated with each user.
     * @param data The HashMap of photo albums to set
     */
...
// -------------------------------------------------------------------------------------
    ...
    /**
     * creates a list of images associated with each photo album for a specific user.
     * @param users The user for whom to set the image list
     * @param index The index of the album in the user's album list
     * @param theAlbum The photo album for which to set the image list
     * @param map The HashMap of photo albums to copy image data from
     */
...
// -------------------------------------------------------------------------------------
    ...
    /**
     * photo album associated with a specific user.
     * @param user The user for whom to get the photo album
     * @return The photoAlbumList associated with the user
     */
